...
const de = {
  ...
  references: {
    ...
    detail: {
      ...
      ctaSub: 'Lass uns gemeinsam etwas bauen, das funktioniert.',
      ctaButton: 'Erstgespräch buchen →',
    },
  },
  testimonials: { label: 'Testimonials', heading: ['Was unsere Kunden', 'über die Zusammenarbeit sagen.'] },
  about: {
    label: 'Über uns',
  ...
  kontaktPage: {
    ...
    budgets: ['Unter CHF 500', 'CHF 500 – 1\'000', 'CHF 1\'000 – 3\'000', 'Über CHF 3\'000', 'Noch unklar'],
    ...
    successBody: 'Vielen Dank für deine Anfrage. Wir melden uns innerhalb von 24 Stunden bei dir.',
...
const en: typeof de = {
  ...
  references: {
    ...
    detail: {
      ...
      ctaSub: "Let's build something together that actually works.",
  ...
  kontaktPage: {
    ...
    heroSub: "Fill in the form or write to us directly — we'll get back to you within 24 hours.",
    services: ['Website Development', 'Social Media Marketing', 'Email & Domain', 'Maintenance & IT Support', 'Other'],
    budgets: ['Under CHF 500', 'CHF 500 – 1,000', 'CHF 1,000 – 3,000', 'Over CHF 3,000', 'Not sure yet'],
    ...
    successBody: "Thank you for your inquiry. We'll get back to you within 24 hours.",
