// Full-screen dissolve mask: a pixelated Perlin-noise field collapses from a
// solid plane to full transparency, with a pulsing glow tracing the boundary.
// Adapted from the "WebGL Loader" reference (Three.js + GLSL, MIT-style demo
// source) in the animation library — reworked into an auto-playing intro
// instead of a click-to-reveal, with the border color driven by a uniform.
