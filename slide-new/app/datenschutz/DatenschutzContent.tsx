      ...
      <Section title="10. Schriftarten (lokal eingebunden)">
        <Block>
          <p>
            ...
            «DM Sans» und «Host Grotesk»). Diese Schriften werden{' '}
  ...
  return (
    <>
      ...
      <Section title="10. Fonts (locally hosted)">
        <Block>
          <p>
            To display fonts consistently, this website uses web fonts (including «DM Sans»
      ...
      <section className="py-20 px-6" style={{ background: 'var(--bg)' }}>
        <div className="max-w-[860px] mx-auto">
          ...
          <div className="pt-8 text-center" style={{ borderTop: '1px solid var(--b)' }}>
            <p className="font-hg text-[0.82rem] tracking-[0.05em] uppercase" style={{ color: 'var(--t3)' }}>
